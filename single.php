        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <article <?php post_class(); ?>>
              ...
              <div class="post-info">
                <i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp;<time datetime="<?php echo get_the_date('c'); ?>"></time><?php echo get_the_date(); ?>&nbsp;&nbsp;
								<i class="fa fa-folder-o" aria-hidden="true"></i>&nbsp;<?php the_category(' , '); ?></div>
